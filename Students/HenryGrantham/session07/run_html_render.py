...
head = hr.Head()
head.append(hr.Title(u"PythonClass = Revision 1087:", style=u"text-align: center; font-style: oblique;"))
...
body.append(hr.Hr(style=u"text-align: center; font-style: oblique;"))
